...
# Kunster 1908 (Bonn)
RV_Kun = Table.read('RV_Kunster1908.dat',format='ascii.csv',header_start=1,names=['date','RV','RV_err'])
RV_Kun['JD']=Time(RV_Kun['date'], format='iso').jd
RV_Kun['source'] = 'Kunster1908'
